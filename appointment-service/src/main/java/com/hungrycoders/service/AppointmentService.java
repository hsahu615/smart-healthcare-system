...
public class AppointmentService {
    ...
    public String bookAppointment(AppointmentRequest appointment) {
        ...
        try {
            DataRequest<DoctorDTO> dataRequestDoctor = doctorFeignClient.getDoctorById(appointment.getDoctorId()).getBody();
            DataRequest<PatientDTO> dataRequestPatient = patientFeignClient.getPatientById(appointment.getPatientId()).getBody();
